...
DEFINE_INTEGER_ARITHMETIC_INSTRUCTION_TEST(IntAdd, "add")
DEFINE_INTEGER_ARITHMETIC_INSTRUCTION_TEST(IntDiv, "sdiv")
DEFINE_INTEGER_ARITHMETIC_INSTRUCTION_TEST(IntMod, "smod")
DEFINE_INTEGER_ARITHMETIC_INSTRUCTION_TEST(IntMul, "mul")
DEFINE_INTEGER_ARITHMETIC_INSTRUCTION_TEST(IntSub, "sub")
