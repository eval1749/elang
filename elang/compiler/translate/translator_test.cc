...
TEST_F(TranslatorTest, DoWhile) {
  ...
  EXPECT_EQ(
      ...
      "0008: int32 %r12 = phi(%c10: %r5, %c18: %r5)\n"
      ...
      "0018: control %c21 = ret(%c8, %e11, %r5)\n"
...
TEST_F(TranslatorTest, For) {
  ...
  EXPECT_EQ(
      ...
      "0015: int32 %r17 = phi(%c15: 0, %c29: 0)\n"
      "0016: control %c18 = call(%c5, %e16, void(int32) System.Void "
      "Sample.Use(System.Int32), %r17)\n"
      "0017: control %c20 = br(%c18)\n"
      "0018: control %c6 = merge(%c20)\n"
      "0019: effect %e19 = get_effect(%c18)\n"
      "0020: control(int32) %c21 = call(%c6, %e19, int32(int32) System.Int32 "
      "Sample.Step(System.Int32), %r17)\n"
      "0021: effect %e22 = get_effect(%c21)\n"
      "0022: int32 %r23 = get_data(%c21)\n"
      ...
      "0030: control %c33 = ret(%c7, %e32, void)\n"
      "0031: control %c2 = merge(%c33)\n"
      "0032: exit(%c2)\n",
      Translate("Sample.Foo"));
}
...
TEST_F(TranslatorTest, ForEach) {
  ...
  EXPECT_EQ(
      ...
      "0017: char* %r19 = phi(%c17: %r9, %c30: %r9)\n"
      "0018: char %r20 = load(%e18, %r5, %r19)\n"
      "0019: control %c21 = call(%c6, %e18, void(char) System.Void Sample.Use("
      "System.Char), %r20)\n"
      "0020: control %c23 = br(%c21)\n"
      "0021: control %c7 = merge(%c23)\n"
      "0022: uintptr %r24 = static_cast(%r19)\n"
      "0023: uintptr %r25 = add(%r24, sizeof(char))\n"
      "0024: char* %r26 = static_cast(%r25)\n"
      ...
      "0031: control %c34 = ret(%c8, %e33, void)\n"
      "0032: control %c2 = merge(%c34)\n"
      "0033: exit(%c2)\n",
      Translate("Sample.Foo"));
}
...
TEST_F(TranslatorTest, While) {
  ...
  EXPECT_EQ(
      ...
      "0007: control %c24 = if_true(%c23)\n"
      "0008: control %c25 = br(%c24)\n"
      "0009: control %c6 = loop(%c14, %c25)\n"
      "0010: control %c21 = br(%c6)\n"
      "0011: control %c7 = merge(%c21)\n"
      "0012: int32 %r16 = phi(%c14: 0, %c25: 0)\n"
      "0013: int32 %r5 = param(%c1, 0)\n"
      "0014: int32 %r18 = add(%r5, 1)\n"
      "0015: int32 %r19 = add(%r16, %r18)\n"
      "0016: bool %r22 = cmp_le(%r19, 10)\n"
      "0017: control %c23 = if(%c7, %r22)\n"
      "0018: control %c26 = if_false(%c23)\n"
      "0019: control %c27 = br(%c26)\n"
      "0020: control %c8 = merge(%c12, %c27)\n"
      "0021: effect %e4 = get_effect(%c1)\n"
      "0022: effect %e15 = effect_phi(%c14: %e4, %c25: %e15)\n"
      "0023: effect %e28 = effect_phi(%c12: %e4, %c27: %e15)\n"
      "0024: control %c29 = ret(%c8, %e28, 0)\n"
      "0025: control %c2 = merge(%c29)\n"
      "0026: exit(%c2)\n",
      Translate("Sample.Foo"));
}
