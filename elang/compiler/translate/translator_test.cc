...
TEST_F(TranslatorTest, Calls) {
  ...
  EXPECT_EQ(
      ...
      "0006: (effect, int32) %t11 = call(%e9, int32(int32) System.Int32 "
      "Sample.Fn1(System.Int32), %r6)\n"
      "0007: effect %e12 = effect_get(%t11, 0)\n"
      "0008: int32 %r7 = param(%t1, 1)\n"
      "0009: (int32, int32) %t14 = tuple(%r6, %r7)\n"
      "0010: (effect, int32) %t15 = call(%e12, int32(int32, int32) "
      "System.Int32 Sample.Fn2(System.Int32, System.Int32), %t14)\n"
      "0011: effect %e16 = effect_get(%t15, 0)\n"
      "0012: control %c18 = ret(%c2, %e16, void)\n"
      "0013: control %c4 = merge(%c18)\n"
...
TEST_F(TranslatorTest, DoWhile) {
  ...
  EXPECT_EQ(
      ...
      "0018: effect %e3 = effect_get(%t1, 1)\n"
      "0019: effect %e12 = effect_phi(%c11: %e3, %c20: %e12)\n"
      "0020: control %c23 = ret(%c8, %e12, %r15)\n"
      "0021: control %c4 = merge(%c23)\n"
      "0022: void %r5 = exit(%c4)\n",
      Translate("Sample.Foo"));
}
...
TEST_F(TranslatorTest, IfMerge) {
  ...
  EXPECT_EQ(
      ...
      "0011: control %c14 = ret(%c8, %e3, %r13)\n"
      "0012: control %c4 = merge(%c14)\n"
      "0013: void %r5 = exit(%c4)\n",
      Translate("Sample.Foo"));
}
