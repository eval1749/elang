...
TEST_F(TranslatorTest, For) {
  ...
  EXPECT_EQ(
      ...
      "0001: control %c4 = control_get(%t1, 0)\n"
      "0002: effect %e5 = effect_get(%t1, 1)\n"
      "0003: (control, effect, bool) %t9 = call(%c4, %e5, bool(int32) "
      "System.Bool Sample.Cond(System.Int32), 0)\n"
      "0004: control %c11 = control_get(%t9, 0)\n"
      "0005: bool %r12 = get(%t9, 2)\n"
      "0006: control %c13 = if(%c11, %r12)\n"
      "0007: control %c14 = if_false(%c13)\n"
      "0008: control %c15 = br(%c14)\n"
      "0009: control %c16 = if_true(%c13)\n"
      "0010: control %c17 = br(%c16)\n"
      "0011: control %c34 = if_true(%c33)\n"
      "0012: control %c35 = br(%c34)\n"
      "0013: control %c6 = loop(%c17, %c35)\n"
      "0014: effect %e10 = effect_get(%t9, 1)\n"
      "0015: effect %e30 = effect_get(%t29, 1)\n"
      "0016: effect %e18 = effect_phi(%c17: %e10, %c35: %e30)\n"
      "0017: int32 %r28 = get(%t25, 2)\n"
      "0018: int32 %r19 = phi(%c17: 0, %c35: %r28)\n"
      "0019: (control, effect, void) %t20 = call(%c6, %e18, void(int32) "
      "System.Void Sample.Use(System.Int32), %r19)\n"
      "0020: control %c22 = control_get(%t20, 0)\n"
      "0021: control %c24 = br(%c22)\n"
      "0022: control %c7 = merge(%c24)\n"
      "0023: effect %e21 = effect_get(%t20, 1)\n"
      "0024: (control, effect, int32) %t25 = call(%c7, %e21, int32(int32) "
      "System.Int32 Sample.Step(System.Int32), %r19)\n"
      "0025: control %c27 = control_get(%t25, 0)\n"
      "0026: effect %e26 = effect_get(%t25, 1)\n"
      "0027: (control, effect, bool) %t29 = call(%c27, %e26, bool(int32) "
      "System.Bool Sample.Cond(System.Int32), %r28)\n"
      "0028: control %c31 = control_get(%t29, 0)\n"
      "0029: bool %r32 = get(%t29, 2)\n"
      "0030: control %c33 = if(%c31, %r32)\n"
      "0031: control %c36 = if_false(%c33)\n"
      "0032: control %c37 = br(%c36)\n"
      "0033: control %c8 = merge(%c15, %c37)\n"
